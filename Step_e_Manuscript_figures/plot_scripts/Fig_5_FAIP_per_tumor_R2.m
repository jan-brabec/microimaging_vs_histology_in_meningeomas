...
hold on
scatter(FAIP_meas_per_sample,median(R2_FAIP_SA_test_bootstrap,2),400,'.')
hold on
R2_FAIP_R2 = calc_R2(FAIP_meas_per_sample,median(R2_FAIP_SA_test_bootstrap,2))

coeffs = polyfit(FAIP_meas_per_sample, median(R2_FAIP_SA_test_bootstrap,2), 1);
